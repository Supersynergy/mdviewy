...
- **超轻量级**。mdmaster 基于 tauri 构建，体积小于 10MB，性能更佳。
- **高可用性**。mdmaster 使用 remirror 编辑器，不仅提供高扩展性，还拥有出色的编辑体验。此外，mdmaster 支持多种编辑模式，如 `源代码`、`所见即所得`。
- **自定义主题**。mdmaster 支持自定义主题，你还可以与他人分享你的主题。
...
目前，我已经使用过很多 Markdown 应用，但没有遇到一个非常适合我的。我一直希望能有一个高效、美观、轻量级、数据安全且能轻松与各种工作流结合的 Markdown 编辑器。这也是做 mdmaster 的初衷。
...
mdmaster 完全且永久开源，如果你想支持 mdmaster，可以给这个项目 `star`。这将给我很大的支持和帮助，爱你。
