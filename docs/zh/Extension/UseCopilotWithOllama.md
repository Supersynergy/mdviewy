...
通常，在一个段落输入一定的文本后，mdmaster 会把你所在的附近的字符，作为上下文让 AI 提供一些建议，大概的样子是这样的:![](https://raw.githubusercontent.com/Supersynergy/mdviewy/refs/heads/main/public/copilot.png)
