...
## mdmaster is in Beta Stage ⚠️

Currently, mdmaster is in the beta stage, and it is recommended to use it with data backups.
...
- **Super lightweight**. The mdmaster is based on tauri and has a volume of less than 10MB and better performance.
- **High availability**. mdmaster uses the remirror editor, which not only provides high scalability, but also has a great editing experience. And, mdmaster supports multiple editing modes, such as `source code`, `wysiwyg`.
- **Custom Theme**. mdmaster supports custom themes, and you can also share your themes with others.
...
mdmaster is completely and permanently open source, if you want to support mdmaster, you can `star` this project. This will give me great support and help, love you.
