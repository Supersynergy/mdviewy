...
現在のmdmasterはまだ発展途上であり、悪い体験やバグがあるかもしれません。その点についてはお詫び申し上げます。興味のあるパートナーや使用上の問題に直面している方は、[issues](https://github.com/Supersynergy/mdviewy/issues/new)や[PR](https://github.com/Supersynergy/mdviewy/compare)を提出して、このプロジェクトに参加してください。
